...
<body class="site <?php echo $option
	...
	<div class="pop d-none d-md-flex flex-column align-items-end">
		<div class="d-flex pop-1"> <a href="callto:#" class="d-flex align-items-center" style="background-color:#EFA835">
	...
	<div class="site-grid">
		...
		<?php if ($this->countModules('bottom-b', true)) : ?>
			<div class="grid-child container-bottom-b" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-offset="1500" data-aos-duration="1000">
